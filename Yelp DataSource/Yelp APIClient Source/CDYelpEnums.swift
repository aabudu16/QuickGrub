...
public enum CDYelpCategoryAlias: String {
   ...
   // Restaurants
    ...
    static let yelpCategory:[CDYelpCategoryAlias] = [.acaiBowls, .african, .asianFusion, .bagels, .bakeries, .barbeque, .beef, .bistros, .brazilian, .brasseries, .breakfastAndBrunch, .bento, .breweries, .buffets, .burgers, .cafeteria, .caribbean, .cajunAndCreole, .chicken, .chickenWings, .chinese, .coffee, .colombian, .comfortFood, .creperies, .cuban, .cupcakes, .danish, .desserts, .dimSum, .diners, .dominican, .donuts, .dumplings, .empanadas, .falafel, .fastFood, .fish, .fishAndChips, .foodTrucks, .french, .gelato, .german, .glutenFree, .greek, .hibachi, .haitian, .halal, .homemadeFood, .hotPot, .hotDogs, .iceCreamAndFrozenYogurt, .indian, .irish, .italian, .japanese, .jewish, .kebab, .kosher, .mexican, .nigerian, .noodles, .pakistani, .pita, .pizza, .rice, .sandwiches,.salmon, .seaFood, .sushiBars, .spanish, .soup, .soulFood, .steakhouses, .streetVendors, .thai, .teaRooms, .vegan, .vegetarian, .wraps, .waffles]
}
